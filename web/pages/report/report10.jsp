<%-- 
    Document   : report10
    Created on : Oct 4, 2018, 9:37:08 AM
    Author     : ridmi_g
--%>
    ...
    <body>
        <section class="app-content">
            <div class="contentcenter">
                <s:form  id="genarateForm10"  theme="simple" method="post">
                    <table >
                        ...
                        <tr>
                            <td>
                                <s:url var="genurl10" action="GenCoursePayment10" />
                                <sj:submit  id="genbtn10" button="true" href="%{genurl10}" value="Generate Report" cssStyle="width: 150px" cssClass="button_aback"/>
                            </td>
                        </tr>
                    </table>
                </s:form>
