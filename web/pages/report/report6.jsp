<%-- 
    Document   : report6
    Created on : Oct 4, 2018, 9:36:36 AM
    Author     : ridmi_g
--%>
            ...
            <div class="contentcenter">
                <s:form  id="genarateForm6"  theme="simple" method="post">
                    <table >
                        ...
                        <tr>
                            <td>
                                <s:url var="genur6" action="GenCoursePayment6" />
                                <sj:submit  id="genbtn6" button="true" href="%{genur6}" value="Generate Report" cssStyle="width: 150px" cssClass="button_aback"/>
                            </td>
                        </tr>
